# Overview
1. Some good [Plugins](https://plugins.jetbrains.com/) for [Intellij IDEA](https://www.jetbrains.com/idea/)
...
1. [Javascript Debugger](TODO)
1. [Javascript Intention Power Pack](TODO)
1. [JUnit](TODO)
1. [Less](TODO)
1. [Lombok](TODO)
1. [Properties](TODO)
