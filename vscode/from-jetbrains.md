...
|Toggle case on selection|TODO|TODO|TODO|TODO|
...
|Go to line|`CTRL+G`|--|
|Find in file|`CTRL+F`|--|
|Duplicate line|`CTRL+D`|Yes|
|Redo|`CTRL+SHIFT+Z`|--|
|Sort lines|`ALT+SHIFT+L`|Yes|
