...
|[`rng.sample_iter(Uniform::from(1..7)).take(8).collect::<Vec<u16>>()`](https://rust-random.github.io/rand/rand/trait.Rng.html#method.sample_iter)<br>`let values: BTreeSet<u16> = rng.sample_iter(Standard).take(8).collect();`|[`ints()`](TODO)|
|[`rng.sample_iter(Uniform::from(500u64..1_000u64)).take(13).collect()`](https://rust-random.github.io/rand/rand/trait.Rng.html#method.sample_iter)<br>`let values: Vec<u64> = rng.sample_iter(Standard).take(16).collect();`|[`longs()`](TODO)|
